...
def upgrade() -> None:
	...
	op.create_table(
		...
		sa.Column("ambulance_employee_exception", sa.Boolean(), nullable=False, server_default=sa.text("0")),
		...
		sa.Column("transfer_etimes12_recorded", sa.Boolean(), nullable=False, server_default=sa.text("0")),
		sa.Column("wards_export_safe", sa.Boolean(), nullable=False, server_default=sa.text("1")),
		sa.Column("nemsis_export_safe", sa.Boolean(), nullable=False, server_default=sa.text("1")),
